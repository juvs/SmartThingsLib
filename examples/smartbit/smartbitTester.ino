...
SmartThingsLib smartThingsLib("smartbit-tester", "SmartBit Tester", "SmartBit", "0.0.1");
...
void setup() {
    ...
    smartThingsLib.callbackForAction("reboot", &callbackReboot);
    smartThingsLib.callbackForAction("info", &callbackInfo);
